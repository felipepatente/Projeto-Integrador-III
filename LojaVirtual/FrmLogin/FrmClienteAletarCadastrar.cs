...
namespace FrmLogin
{
    public partial class FrmClienteAletarCadastrar : Form
    {
        public FrmClienteAletarCadastrar()
        {
            InitializeComponent();
        }
        ...
        private void FrmClienteAletarCadastrar_Load(object sender, EventArgs e)
        {
